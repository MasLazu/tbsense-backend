...
public class TbSenseBackendReadDbContext : BaseReadDbContext
{
    public TbSenseBackendReadDbContext(DbContextOptions<TbSenseBackendReadDbContext> options) : base(options)
    {
    }
