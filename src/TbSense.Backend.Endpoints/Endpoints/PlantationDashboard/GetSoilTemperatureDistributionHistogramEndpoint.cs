...
public class GetSoilTemperatureDistributionHistogramEndpoint : BaseEndpoint<PlantationHistogramDaysRequest, SoilTemperatureDistributionHistogramResponse>
{
    public IPlantationDashboardService PlantationDashboardService { get; set; } = null!;

    public override void ConfigureEndpoint()
    {
        Get("{plantationId}/histogram/soil-temperature-distribution");
    ...
    public override async Task HandleAsync(PlantationHistogramDaysRequest req, CancellationToken ct)
    {
        ...
        SoilTemperatureDistributionHistogramResponse result = await PlantationDashboardService.GetSoilTemperatureDistributionHistogramAsync(
            req.PlantationId,
            days,
            binCount,
            ct);
